...
?>
                ...
                <div align="center" style="background-color: #87CEFA; margin-left:300px;margin-right:300px;">
                    <br>
                    <h2 align="center"> Cadastro Lembrete </h2>
                    <?php
                     
                     $x = null;
                     echo $this->Form->create($x,['url' => ['controller'=>'Eventos','action'=>'insertevento']]);

                     echo $this->Form->input('tipevent',['label' => 'Tipo do Evento:','id' => 'tipevent',
                          'options'=>$Tip]);
                        
                     echo $this->Form->input('desc',['label' => 'Descrição:','id' => 'desc']);

                     echo $this->Form->input('nome',['label' => 'Nome:','id' => 'nome']);
